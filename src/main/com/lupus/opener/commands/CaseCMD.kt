...
object CaseCMD : SupCommand() {
    var meta = CommandMeta().setName("case").setUsage(usage("/case help"))
        .setDescription(colorText("&6Komenda administracyjna do skrzyń")).addPermission("case.admin")
}