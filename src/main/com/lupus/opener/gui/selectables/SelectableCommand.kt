...
class SelectableCommand(itemStack: ItemStack?, var command: String) : PlayerSelectableItem(true, itemStack) {
    override fun execute(player: Player, vararg objects: Any) {
