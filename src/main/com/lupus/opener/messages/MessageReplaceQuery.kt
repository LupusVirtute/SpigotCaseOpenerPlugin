...
class MessageReplaceQuery {
    private val queryReplacement: MutableMap<String, String> = HashMap()
    fun addQuery(key: String, replacement: String): MessageReplaceQuery {
        queryReplacement[key] = replacement
        return this
    }
